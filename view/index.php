        ...
        <div class="container-fluid"><a class="navbar-brand" href="#">Ben Fleuty |&nbsp;CMP 306<br>Dynamic Web
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav">
                    ...
                    <li class='nav-item dropdown'><a class='dropdown-toggle nav-link' aria-expanded='false'
                                                     data-bs-toggle='dropdown'>Block Three</a>
                        <div class='dropdown-menu'>
                            <a class='dropdown-item' href='../coursework/block/three'>Work</a>
                            <a class='dropdown-item' href='../coursework/block/three/report'>Report</a>
                        </div>
                    </li>
                </ul>
            </div>
...
<section class="projects-horizontal">
    <div class="container">
        <div class="intro">
            <h2 class="text-center">Weekly Work</h2>
            <p class="text-center">Here you will find links to the work completed each week if it is separate to the
                block work.</p>
        </div>
            ...
            <div class="col-sm-6 item">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <p class="description">This is my interest.</p>
                    </div>
                </div>
            </div>
        </div>
