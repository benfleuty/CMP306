        ...
        <div class="row">
            <div class="col-lg-10 col-xl-8 offset-lg-1 offset-xl-2">
                ...
                <div class="text">
                    ...
                    <p>Below are the ERDs for this week's work.</p>
                    <figure class="figure d-block">
                        <img class="figure-img" src="../image/ERD.svg" alt="ERD">
                        <figcaption class="figure-caption">Fig. 1</figcaption>
                    </figure>
                    <figure class="figure d-block">
                        <img class="figure-img" src="../image/ERD_Simple.svg" alt="ERD Simple">
                        <figcaption class="figure-caption">Fig. 2</figcaption>
                    </figure>
                    <p>Above are two diagrams for the same table. Fig. 1 shows the tables and their respective fields.
                        This is okay in a small table like this but this is not a scalable design. Fig. 2 shows the same
                        tables but without their attributes. This is a more scalable design since the tables and their
                        relations are still shown, but in a more compact and clutter-free way. This is better for large
                        databases as the structure of the database can easily be seen.</p>
                </div>
            </div>
        </div>
    </div>
